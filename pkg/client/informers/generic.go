...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=cache.tongdun.net, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("redisclusters"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cache().V1alpha1().RedisClusters().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("redisstandalones"):
