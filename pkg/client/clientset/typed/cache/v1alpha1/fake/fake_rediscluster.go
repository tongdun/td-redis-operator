...
var redisclustersResource = schema.GroupVersionResource{Group: "cache.tongdun.net", Version: "v1alpha1", Resource: "redisclusters"}

var redisclustersKind = schema.GroupVersionKind{Group: "cache.tongdun.net", Version: "v1alpha1", Kind: "RedisCluster"}
