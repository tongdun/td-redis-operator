...
type CacheV1alpha1Interface interface {
	...
	RedisClustersGetter
	RedisStandalonesGetter
	RedisStandbiesGetter
}

// CacheV1alpha1Client is used to interact with features provided by the cache.tongdun.net group.
type CacheV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CacheV1alpha1Client) RedisClusters(namespace string) RedisClusterInterface {
	return newRedisClusters(c, namespace)
}

func (c *CacheV1alpha1Client) RedisStandalones(namespace string) RedisStandaloneInterface {
	return newRedisStandalones(c, namespace)
}

func (c *CacheV1alpha1Client) RedisStandbies(namespace string) RedisStandbyInterface {
	return newRedisStandbies(c, namespace)
}
